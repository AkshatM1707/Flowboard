  ...
  return (
    <ConvexClientProvider>
      <main className="h-full bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 relative overflow-hidden">
        <Sidebar />
        <div className="h-full pl-[68px] transition-all duration-300 ease-in-out">
            ...
            <div className="h-full flex-1 relative">
              ...
              <div className="relative z-10 h-full flex flex-col">
                ...
                <div className="flex-1 p-6 overflow-hidden">
                  <div className="h-full bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 overflow-hidden">
                    {children}
                  </div>
                </div>
              </div>
